...
client.on("message", async message => {
    ...
    if (command == "leave") {
        ...
        if(message.author.id != "476088952726749188") return message.reply("**Sorry, you don't have permission to use this!**");/* ·Ê ”„Õ  Õÿ «·«ÌœÌ Õﬁﬂ*/
...
client.on('message', ( message ) => {
  ...
  if(message.channel.id !== '535468009100410883') return;
